...
Usage (wheels lifted, operator ready):
    PYTHONPATH=src python3 examples/other/39_map1_ir_line_follow.py --duration 120

Usage (simulation, no motor):
    PYTHONPATH=src python3 examples/other/39_map1_ir_line_follow.py --dry-run --duration 30

Usage (Phase 1 only, sensor-blind motion followed by a stopped hold):
    PYTHONPATH=src python3 examples/other/39_map1_ir_line_follow.py \
