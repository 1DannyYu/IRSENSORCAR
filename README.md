...
| I want to... | Go to |
|---|---|
| See what the robot looks like and what parts it's built from | [Live Site](https://1dannyyu.github.io/IRSENSORCAR/), [Inventory](https://1dannyyu.github.io/IRSENSORCAR/inventory/), [assets/](assets/) |
...
| Check that the code is tested | [tests/](tests/) — split into [tests/ai_camera/](tests/ai_camera/) and [tests/other/](tests/other/) |
...
| Preview or build the website | [docs/project-reference.md#website](docs/project-reference.md#website) |
...
├── tests/                 Automated tests (pytest), split into ai_camera/ and other/
