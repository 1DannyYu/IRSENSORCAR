...
it able to cut main power instantly. Run `examples/other/14_all_sensors_preflight_check.py` first.
...
drives along the line of sight.
    ...
    PYTHONPATH=src python3 examples/ai_camera/24_cam_linear_speed_check.py --speed 200
"""
