...
Run this ON the Raspberry Pi, not on the Mac:
    ...
    python3 examples/ai_camera/05_ai_camera_check.py           # detection only
    python3 examples/ai_camera/05_ai_camera_check.py --photo   # also capture a test still
    python3 examples/ai_camera/05_ai_camera_check.py --inference  # also run a 5 s on-sensor inference pass
