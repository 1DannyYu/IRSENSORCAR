...
by the vision cross-bar + position supervision.
    ...
    PYTHONPATH=src python3 examples/ai_camera/32_cam_tag_nav_drive.py --dry-run --duration 10

    # supervised run
    PYTHONPATH=src python3 examples/ai_camera/32_cam_tag_nav_drive.py --duration 15 \\
