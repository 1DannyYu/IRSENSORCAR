...
car actually is?*
    ...
    PYTHONPATH=src python3 examples/ai_camera/31_cam_ground_tag_pose.py \
        --tag-map scratch/landmarks/task1-tag-map.json

    # on the Mac, with an existing image
    PYTHONPATH=src uv run --extra vision python examples/ai_camera/31_cam_ground_tag_pose.py \
