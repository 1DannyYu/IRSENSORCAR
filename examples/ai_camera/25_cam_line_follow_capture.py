...
closed-loop driving is attempted.
    ...
    PYTHONPATH=src python3 examples/ai_camera/25_cam_line_follow_capture.py
    PYTHONPATH=src python3 examples/ai_camera/25_cam_line_follow_capture.py --threshold 100 --output /tmp/line-follow
...
Raspberry Pi OS. See `examples/ai_camera/05_ai_camera_check.py` for the same rationale.
"""
