...
never *commands* turns from wheel timing because the camera decides.
    ...
    PYTHONPATH=src python3 examples/ai_camera/29_cam_route_nav_drive.py --dry-run --duration 10

    # supervised run
    PYTHONPATH=src python3 examples/ai_camera/29_cam_route_nav_drive.py --duration 120 \\
