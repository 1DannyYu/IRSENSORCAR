...
Usage:
    ...
    PYTHONPATH=src python3 examples/41.1_motor_spin_duration_check.py --speed 150 --duration-s 2.24 --direction right

    # too far / not far enough -> adjust and re-run
    PYTHONPATH=src python3 examples/41.1_motor_spin_duration_check.py --speed 150 --duration-s 1.80 --direction right
"""
