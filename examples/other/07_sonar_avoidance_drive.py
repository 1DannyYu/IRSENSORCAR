...
Run on the Raspberry Pi (system interpreter, not uv):
    ...
    PYTHONPATH=src python3 examples/other/07_sonar_avoidance_drive.py --dry-run
    PYTHONPATH=src python3 examples/other/07_sonar_avoidance_drive.py --duration 60
    PYTHONPATH=src python3 examples/other/07_sonar_avoidance_drive.py --ground --duration 60
