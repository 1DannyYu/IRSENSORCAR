...
Examples::
    ...
    PYTHONPATH=src python3 examples/other/40_map1_ir_phase_test.py --phase 1
    PYTHONPATH=src python3 examples/other/40_map1_ir_phase_test.py --phase 3 --speed 150
"""
