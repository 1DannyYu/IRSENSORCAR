...
measured elsewhere (`examples/ai_camera/23_cam_spin_rate_check.py`, done on a textured wall
...
Usage:
    PYTHONPATH=src python3 examples/41.2_motor_spin_angle_sweep.py --speed 150
    PYTHONPATH=src python3 examples/41.2_motor_spin_angle_sweep.py --speed 150 --durations 2,4,6,8,10
"""
